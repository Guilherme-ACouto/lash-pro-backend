...
public class FichaController {
    ...
    public ResponseEntity<FichaResult> create(@Valid @RequestBody CreateFichaRequest req) {
        var result = createFichaUseCase.execute(new CreateFichaUseCase.CreateFichaCommand(
    ...
    public ResponseEntity<FichaResult> update(@PathVariable UUID id,
        ...
        var result = updateFichaUseCase.execute(new UpdateFichaUseCase.UpdateFichaCommand(
    ...
    public ResponseEntity<LashMappingResult> createMapping(@PathVariable UUID fichaId,
        ...
        var result = createLashMappingUseCase.execute(new CreateLashMappingUseCase.CreateLashMappingCommand(
    ...
    public ResponseEntity<LashMappingResult> updateMapping(@PathVariable UUID fichaId,
        ...
        var result = updateLashMappingUseCase.execute(new UpdateLashMappingUseCase.UpdateLashMappingCommand(
    ...
    public ResponseEntity<Void> deleteMapping(@PathVariable UUID fichaId,
                                              @PathVariable UUID mappingId) {
        deleteLashMappingUseCase.execute(mappingId);
