package com.bravapro.finance.infrastructure.persistence.mapper;
...
public class FinancialEntryPersistenceMapper {
    ...
    public FinancialEntry toDomain(FinancialEntryEntity e) {
        return FinancialEntry.builder()
                ...
                .expenseType(e.getExpenseType() != null ? FinancialEntryExpenseType.valueOf(e.getExpenseType()) : null)
