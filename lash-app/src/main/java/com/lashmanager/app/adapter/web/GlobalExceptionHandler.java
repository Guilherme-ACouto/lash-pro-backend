...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handlePlatformAdminRequired(
      PlatformAdminRequiredException ex) {
    return err(HttpStatus.FORBIDDEN, ex.getMessage());
  }
  ...
  public ResponseEntity<ErrorResponse> handleActivationKeyInvalid(
      ActivationKeyInvalidException ex) {
    return err(HttpStatus.NOT_FOUND, ex.getMessage());
  }

  @ExceptionHandler(ActivationKeyExpiredException.class)
  public ResponseEntity<ErrorResponse> handleActivationKeyExpired(
      ActivationKeyExpiredException ex) {
  ...
  public ResponseEntity<Map<String, Object>> handleHasFutureAppointments(
      HasFutureAppointmentsException ex) {
  ...
  public ResponseEntity<ErrorResponse> handleFinancialEntryNotFound(
      FinancialEntryNotFoundException ex) {
    return err(HttpStatus.NOT_FOUND, ex.getMessage());
  }

  @ExceptionHandler(FinancialEntryLinkedToAppointmentException.class)
  public ResponseEntity<ErrorResponse> handleFinancialEntryLinked(
      FinancialEntryLinkedToAppointmentException ex) {
    return err(HttpStatus.CONFLICT, ex.getMessage());
  }
  ...
  public ResponseEntity<ErrorResponse> handleInventoryItemNotFound(
      InventoryItemNotFoundException ex) {
    return err(HttpStatus.NOT_FOUND, ex.getMessage());
  }

  @ExceptionHandler(InventoryItemCodeAlreadyExistsException.class)
  public ResponseEntity<ErrorResponse> handleInventoryItemCodeExists(
      InventoryItemCodeAlreadyExistsException ex) {
    return err(HttpStatus.CONFLICT, ex.getMessage());
  }

  @ExceptionHandler(InventoryItemHasMovementsException.class)
  public ResponseEntity<ErrorResponse> handleInventoryItemHasMovements(
      InventoryItemHasMovementsException ex) {
    return err(HttpStatus.CONFLICT, ex.getMessage());
  }
  ...
  public ResponseEntity<ErrorResponse> handleClientAlreadyHasFicha(
      ClientAlreadyHasFichaException ex) {
    return err(HttpStatus.CONFLICT, ex.getMessage());
  }
