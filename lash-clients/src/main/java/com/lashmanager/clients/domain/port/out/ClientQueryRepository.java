...
/**
 * Porta de leitura — separada de ClientRepository (escrita) conforme RBK-27.
 * Reaproveita o mesmo ClientJpaRepository/ClientMapper por baixo (Nível 2:
 * separação lógica, não física — ver design.md do refactor-backend).
 */
