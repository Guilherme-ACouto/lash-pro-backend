...
/**
 * Porta de escrita. Leitura (listagem/filtro) foi separada para
 * InventoryItemQueryRepository (RBK-27) — findById continua aqui porque os
 * use cases de escrita precisam do agregado completo.
 */
