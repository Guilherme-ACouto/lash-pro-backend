...
/**
 * Porta de leitura — separada de InventoryMovementRepository (escrita) conforme
 * RBK-27. Movimentos são append-only (só `save`); listagem é o único caso de
 * leitura, daí a porta ficar bem enxuta.
 */
