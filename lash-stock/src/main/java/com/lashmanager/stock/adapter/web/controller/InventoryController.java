...
public class InventoryController {
  ...
  @PostMapping
  public ResponseEntity<InventoryItemResult> create(
      @Valid @RequestBody CreateInventoryItemRequest req) {
    var result =
        createItemApplicationService.when(
  ...
  @PutMapping("/{id}")
  public ResponseEntity<InventoryItemResult> update(
      @PathVariable UUID id, @Valid @RequestBody UpdateInventoryItemRequest req) {
    var result =
        updateItemApplicationService.when(
  ...
  public ResponseEntity<Page<InventoryItemResult>> list(
    ...
    return ResponseEntity.ok(
        listItemsUseCase.execute(
            new ListInventoryItemsUseCase.ListInventoryItemsQuery(search, status, filter),
            pageable));
  }
  ...
  public ResponseEntity<InventoryItemResult> activate(@PathVariable UUID id) {
    return ResponseEntity.ok(
        deleteItemApplicationService.when(new SetInventoryItemActiveCommand(id, true)));
  }

  @PatchMapping("/{id}/deactivate")
  public ResponseEntity<InventoryItemResult> deactivate(@PathVariable UUID id) {
    return ResponseEntity.ok(
        deleteItemApplicationService.when(new SetInventoryItemActiveCommand(id, false)));
  }
  ...
  public ResponseEntity<RegisterPurchaseUseCase.RegisterPurchaseResult> registerPurchase(
    ...
    var result =
        registerPurchaseApplicationService.when(
  ...
  public ResponseEntity<InventoryMovementResult> registerExit(
    ...
    var result =
        registerManualExitApplicationService.when(
            new RegisterManualExitCommand(
