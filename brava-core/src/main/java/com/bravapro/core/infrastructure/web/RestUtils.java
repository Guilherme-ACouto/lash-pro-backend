 ...
 * domínio (sem DTO de resposta), sinalizando o tipo de operação via header {@code X-bravapro-alert}
 * em vez de um envelope de mensagem no corpo. Erros continuam pelo {@code GlobalExceptionHandler}
 * (ver {@code com.bravapro.core.adapter.web.dto.Error}) — {@code RestUtils} cobre só sucesso.
 */
