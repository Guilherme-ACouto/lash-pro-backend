 ...
 * serializado).
 *
 * <p><b>Extensão do Brava Pro</b>: {@code details} carrega dado estruturado quando o erro precisa de
 ...
 * porque {@code param} não serializa e o Brava Pro já tinha esse caso de uso real antes da migração.
 */
@Getter
@Builder
